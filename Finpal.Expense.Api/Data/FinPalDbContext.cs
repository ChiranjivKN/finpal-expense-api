...
public class FinPalDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder) //Overriding virtual method from DbContext class
    {
        ...
        modelBuilder.Entity<Expenses>(entity =>
        {
            ...
            entity.HasOne(e => e.Category).WithMany(c => c.Expenses).HasForeignKey(e => new { e.UserId, e.CategoryId }).HasConstraintName("FK_Expenses_Categories").OnDelete(DeleteBehavior.Restrict);
        ...
        modelBuilder.Entity<Budget>(entity =>
        {
            ...
            entity.HasOne(b => b.Category).WithMany(c => c.Budgets).HasForeignKey(b => new { b.UserId, b.CategoryId }).HasConstraintName("FK_Budgets_UserID_CategoryID").OnDelete(DeleteBehavior.Restrict);
